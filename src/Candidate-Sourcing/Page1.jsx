...
// import { FaUserTie } from "react-icons/fa"; // Professional/candidate icon
...
//           {/* Foreground icon */}
//           <FaUserTie className="relative z-10 text-white w-40 h-40 md:w-56 md:h-56" />
//         </div>
//       </div>
//     </section>
//   );
